...
{
	CHECK_ASSEMBLE_ERROR("{ jump }", Warning, "Using jump instructions");
	CHECK_ASSEMBLE_ERROR("{ jumpi }", Warning, "Using jump instructions");
	CHECK_ASSEMBLE_ERROR("{ a: jump(a) }", Warning, "Using jump instructions");
	CHECK_ASSEMBLE_ERROR("{ a: jumpi(a) }", Warning, "Using jump instructions");
}
